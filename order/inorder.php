...
if(empty($_POST['order_id'])){
	...
	$sql="INSERT INTO online_store.order (order_id, customer_id, customer_name, employee_id, amount, point_redeem, total, transaction_status)
...
<form name="back" method="post" action="Orderform.php" class="back-btn">
